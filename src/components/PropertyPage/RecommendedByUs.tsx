...
interface RecommendedByUsProps {
  similarProperties?: Property[];
  variant?: string;
  loading?: boolean;
}

export const RecommendedByUs: React.FC<RecommendedByUsProps> = ({
  similarProperties,
  variant,
  loading = false,
}) => {
  ...
  return (
    <div className="bg-white ">
      <h2 className="text-lg sm:text-xl font-semibold mb-4 sm:mb-6">
        Recommended By Us ({displayProperties.length})
      </h2>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6">
